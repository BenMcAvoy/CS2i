...
#include "CompiledShaderPS.hpp"
#include "CompiledShadervS.hpp"
// DirectX
#include <stdio.h>
#include <d3d11.h>
...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    // Create the vertex shader
    {
        ...
        //
        if (bd->pd3dDevice->CreateVertexShader(VShader, sizeof(VShader), nullptr, &bd->pVertexShader) != S_OK)
        {
            // Handle error
            return false;
        }
        ...
        if (bd->pd3dDevice->CreateInputLayout(local_layout, 3, VShader, sizeof(VShader), &bd->pInputLayout) != S_OK)
        {
    ...
    // Create the pixel shader
    {
        ...
        if (bd->pd3dDevice->CreatePixelShader(PShader, sizeof(PShader), nullptr, &bd->pPixelShader) != S_OK)
        {
            // Handle error
            return false;
        }
